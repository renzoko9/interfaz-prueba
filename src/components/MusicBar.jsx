...
import { FaHeart, FaStepBackward, FaStepForward, FaPlay, FaRandom, FaVolumeUp } from 'react-icons/fa'

const MusicBar = () => {
    return (
      <div className="fixed bottom-0 left-0 bg-[#EB5757] text-white p-4 w-full">
          ...
          <div className="col-start-2 col-span-2 flex flex-col items-center">
            ...
            <div className="flex justify-between mt-8">
              <div className="flex items-center">
                ...
                <div className="progress-bar h-2 w-96 bg-gray-700 rounded-full">
